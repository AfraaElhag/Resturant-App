...
">
      <div class="osahan-signup login-page" >
         ...
         <div class="vh-100">
           ...
           <div class=" px-3 pt-2 pb-1 d-flex align-items-center" >
            <h5 class=" m-0 text-white pl-2 " style="width: 50%">انشاء حساب جديد  </h5>
            ...
            <div class="p-4">
               ...
               <form class="mt-5 mb-4" action="{{ route('generateOtp') }}"  method="POST" id="signup">
                  @csrf
 ...
 @error('name')
                  ...
                  <div class="form-group row">
                     ...
                     <input type="tel" placeholder="{{__('lang.Enter Mobile')}}" class="form-control col-8 bold" id="exampleInputNumber" aria-describedby="numberHelp" style="color: red; font-weight: bold;" name="phone"  value="{{ old('phone') }}" oninvalid="this.setCustomValidity('الرجاء إدخال هذا الحقل')" onchange="this.setCustomValidity('')" required>
...
@endif
            ...
            <div class="new-acc fixed-bottom d-flex align-items-center justify-content-center  " id="foot">
            <a href="{{ route('loginform') }}"><p class="text-center text-white m-0 ">{{__('lang.Already an account? Sign in')}}</p></a>
            </div>
         </div>
      </div>
 </body>
